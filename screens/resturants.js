            ...
            <TouchableOpacity onPress={()=> openSheet(d.id)} key={i} style={{display: d.deal_quantity > 0 && d.status == 1  ? 'flex' : 'none'}}>
                <View style={styles.mcCard} key={d.id}>
                    ...
                    <View style={{marginLeft:15,width:'100%',paddingRight:100,...styles.flexRow,width:'100%',justifyContent: 'space-between'}}>
                        ...
                        <View >
                            <Text style={{fontFamily:'Poppins-SemiBold',fontSize:moderateScale(15),marginBottom:5}}>${d.deal_price}</Text>
                        </View>
                    </View>
                </View>
            </TouchableOpacity>
        ...
        <View style={styles.container}>
            ...
            <ImageBackground source={{uri: 'data:image/png;base64,'}} resizeMode="cover" style={{height:220}} >
                <View style={{width: '100%', height: 220,backgroundColor: '#1e3865e0',position:'relative'}}>
                    <Text style={{color:'#fff', fontSize:moderateScale(20),fontFamily:'Poppins-SemiBold',position:'absolute',bottom:40,left:20}}>{resData?.user?.name}</Text>
                </View>
            </ImageBackground>
                                ...
                                <View style={{marginLeft:15}}>
                                    <View style={{width:'89%'}}>
                                        <View style={{flexDirection: 'row',alignItems: 'center',justifyContent: 'space-between'}}>
                                            <Text style={{fontFamily:'Poppins-SemiBold',fontSize:moderateScale(15),marginBottom:5}}>{currentDeal?.deal_name}</Text>
                                            <Text style={{fontFamily:'Poppins-SemiBold',fontSize:moderateScale(15),marginBottom:5}}>${currentDeal?.deal_price}</Text>
                                        </View>
                                        <View style={{flexDirection: 'row',alignItems: 'center'}}>
